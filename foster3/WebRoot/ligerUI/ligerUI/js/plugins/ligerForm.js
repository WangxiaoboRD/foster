...
//	//zhangyq add 2013-6-26 11:19:02
//	$.ligerMethos.Form = $.ligerMethos.Form||{};
//	//zhangyq add end 2013-6-26 11:19:13
//	$.ligerDefaults.Form = {
//		//控件宽度
//		inputWidth : 180,
//		//标签宽度
...
//		var fieldIndex = jinput.attr("fieldindex"), ltype = jinput
//				.attr("ltype");
//		if (fieldIndex != null) {
...
//				if (field.textField) {
//					var textInput = $(
//							"<input type='text' name='" + field.textField
//									+ "' />").insertAfter(jinput);
//					if (p.appendID)
...
//				}
//			} else {
//				if ($.inArray(ltype, [ "select", "combobox", "autocomplete",
//						"popup", "radiolist", "checkboxlist", "listbox" ]) != -1) {
//					if (!jinput.attr("id"))
//						jinput.attr("id", liger.getId('hidden'));
...
//				case "autocomplete":
//				case "popup":
//					var textField = field.textField || field.comboboxName
//							|| liger.getId();
...
//					break;
//				case "checkboxlist":
//					$("<div></div>").insertAfter(jinput).ligerCheckBoxList(
//							options);
//					break;
//				case "radiolist":
//					$("<div></div>").insertAfter(jinput)
//							.ligerRadioList(options);
//					break;
//				case "listbox":
...
//			return 'Form';
//		},
//		//zhangyq add 2013-6-26 11:20:10
//		_extendMethods : function() {
//			return  $.ligerMethos.Form;
//		},
//		// end of zhangyq add 2013-6-26 11:20:23
//		_init : function() {
...
//				if (field.group) {
//					//trim
//					field.group = field.group.toString()
//							.replace(/^\s\s*/, '').replace(
//									/\s\s*$/, '');
...
//						out.push('><ul>');
//						//append label
//						out.push(g._buliderLabelContainer(
//												field,
//												index));
//						//append input 
//						out.push(g._buliderControlContainer(
//												field,
//												index));
//						//append space
//						out.push(g._buliderSpaceContainer(
//												field,
//												index));
//						out.push('</ul></li>');
//
...
//			var g = this, p = this.options;
//			var width = field.width || p.inputWidth, name = field.name
//					|| field.id, type = (field.type || "text")
//					.toLowerCase(), readonly = (field.readonly || (field.editor && field.editor.readonly)) ? true
//					: false;
//			var out = [];
...
//			} else if ($.inArray(type, [ "select", "combobox",
//					"autocomplete", "popup", "radiolist",
//					"checkboxlist", "listbox" ]) != -1) {
