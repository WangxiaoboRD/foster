...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function(){
	  		 var formOption = {
	  		 	 url: "feed_transfer!save",	// 此处也是必须的
	  			 labelWidth: 85, 
	  			 inputWidth: 170,
           		 space:20,
           		 excludeClearFields:['e.remark','e.registDate','driver','transportCo','outFarmer','outBatch','inFarmer','inBatch'],
	  			 fields: [
					{ display: "转接时间", name: "e.registDate", group: "饲料转接单", groupicon: groupicon, type: "date",validate: { required: true },options: { value: new Date(), showTime: false }},
					...
					{ display: "转入代养户", name:"e.inFarmer.id",newline:true,comboboxName: 'inFarmer',type:"select",newline:true,options:{
					    url:'farmer!loadByPinYin',
					    valueField: 'id', 
				        textField: 'name',
				        keySupport:true,
					...
					{ display: "运输公司", name:"e.transportCo",newline:true,comboboxName: 'transportCo',type:"select",newline: true,options:{
						...
						onBeforeOpen: function() {
		                	var g = this;
		                	g.setParm('e.code', $("input[id='e.outFarmer.id']").val());
		                },
		                onSelected: function (nv){
