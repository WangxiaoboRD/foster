		 ...
		 //生成ligerUI form
	  	 form = $("form").ligerForm({
             ...
             fields: [
                ...
                { display: "物料名称", name: "e.name", options: { value: '${e.name}', readonly: true}, type: "text"},
                { display: "物料编码", name: "e.code",options: { value: '${e.code}',readonly: true }, type: "text"},
                { display: "物料规格", name: "e.spec",options: { value: '${e.spec}' },validate: { required: true }, type: "text"},
                { display: "物料单位", name: "e.unit.dcode", type:"select" ,validate:{ required:true }, options:{
