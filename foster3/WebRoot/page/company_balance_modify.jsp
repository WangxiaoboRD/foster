		 ...
		 var groupicon = "../ligerUI/ligerUI/skins/icons/communication.gif";
	  	 form = $("form").ligerForm({
             ...
             fields: [
					...
					{display: "结算日期", name: "e.registDate", type: "date",validate: {required:true},group: "公司结算单", groupicon: groupicon,options: {value:'${e.registDate}',format:"yyyy-MM-dd",alwayShowInDown: true}},
