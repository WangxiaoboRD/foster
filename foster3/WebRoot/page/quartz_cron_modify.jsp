    ...
    <script type="text/javascript">
        ...
        $(function(){
            ...
            form = $("form").ligerForm({
   	  		 	 ...
   	  		 	 space: 20,
	  			 fields: [
					{ display: "表达式编号", name: "e.id", options: { value: '${e.id}' }, type: "text", hidden: true },
                	...
                	{ display: '指定', name: "e.assignMonths", type: "checkboxgroup", newline: true, width: 500, options:{
                		rowSize: 12,        
    			       	data: months,
    			       	name: 'e.assignMonths',
    			       	value: '${e.assignMonths}',
    			       	disabled: true
                    }},
                    { display: '使用星期', name: "e.useWeek", type: "checkbox", width: 500, newline: true, group: '星期', groupicon: settingicon, options: { value: '${e.useWeek}', checkedValue: 'Y', uncheckedValue: 'N' }},
			      ...
			      // 若自定义==0，手动设置==1
	          	  if (value == '0') {
	          		...
	          		// 手动设置元素置为禁用状态
					   ...
					   // 使用星期
					   // 星期单选框
					   if (liger.get('e.useWeek').getChecked()){
		                    ...
		                    setDisabled(dayEles, true);// 禁用周期和指定元素
		                }else {
						   // 天单选框
						   setDisabled(handedElements[2], false); // 启用天条件单选框
