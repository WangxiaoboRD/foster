        ...
        var grid = null;
           $(function () {
      		                ...
      		                { text: '删除', icon: 'delete', expression:'==0', disabled:true, click: function(item) {
          		          	...
          		          	{ text: '查看', icon: 'view', expression:'!=1', disabled:true, click: function(item) {
          		            	var selectedRow = item.selectGrid.selected; 
		   	    				...
		   	    				$.pap.addTabItem({ 
		   	   	    				text: '初始化数据/查看', 
		   	   	    				url: 'debug_sql!loadDetailById?id='+grid.selected[0]['id'],
		   	   	    				param: selectedRow 
		   	   	    			});
          		            }}
                  		]
                ...
                form={
                    ...
                    space:20,
	                fields:[
						{ display: "操作人", name:"e.operatorId", type:"select", options:{
						    url:'users!load',
             	...
             	var gridoption={
             		url:'debug_sql!loadByPage',
                    columns:[
                         { display: '编号', name: 'id', hide: true },
                         { display: '提取文件', name: 'fileName', width: 300 },
                         ...
                         { display: '初始Hql', name: 'oldHql', width: 500 },
                         { display: '初始Sql', name: 'oldSql', width: 500 },
                         { display: '转换Sql', name: 'newSql', width: 500 },
