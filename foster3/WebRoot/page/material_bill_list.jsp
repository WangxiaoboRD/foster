        ...
        $(function () {
        	   ...
        	   var toolBarOption = { 
   	                   items: [
							 ...
							 $.pap.addTabItem({ 
		   	    	        	tabid: 'materialBillModify'+grid.selected[0]['id'],
			   	    	        text: '物料单/修改', 
			   	    	        url: 'material_bill!loadUpdateById?id='+grid.selected[0]['id']
			   	    	     });
	   	   			      }},
	   	   	              { line:true },
	   	   	              ...
	   	   	              { text: '查看', icon: 'view', expression:'!=1', disabled:true, click: function(item){
		   	    				...
		   	    				$.pap.addTabItem({ 
			   	    				tabid: 'materialBill'+grid.selected[0]['id'],
		   	   	    				text: '物料单【'+grid.selected[0]['id']+'】',
		       	   					params:{ 'ids':ids,'id':grid.selected[0]['id']},
		   	   	    				url: 'material_bill!loadDetailById?id='+grid.selected[0]['id']
		   	   	    			});
	   	   			      }},
	   	   				  { line:true },
        	 ...
        	 form = {
                 labelWidth: 70,
                 fields:[
						{ display: "物料单号", name:"e.id", type:"text" },
						...
						{ display: "领用时间", name: "e.tempStack.startTime", type: "date", space: 10 },
        	 ...
        	 var gridoption={
                    ...
                    url:'material_bill!loadByPage',
                    exportBtn: true,
			        exportUrl: 'material_bill!exportFile'
             }
