    ...
    <script type="text/javascript">
        ...
        $(function () {
        	   ...
        	   var toolBarOption = { 
   	                   items: [
	   	   	              { text: '查看', icon: 'view', expression:'!=1', disabled:true, click: function(item){
		   	    				...
		   	    				$.pap.addTabItem({ 
			   	    				tabid: 'feedOutWare'+grid.selected[0]['id'],
		   	   	    				text: '饲料出库单【'+grid.selected[0]['id']+'】',
		       	   					params:{ 'ids':ids,'id':grid.selected[0]['id']},
		   	   	    				url: 'feed_out_ware!loadDetailById?id='+grid.selected[0]['id']
		   	   	    			});
	   	   			      }},
                   		]
             	};
        	 ...
        	 var gridoption={
                    ...
                    url:'feed_out_ware!loadByPage',
                    exportBtn: true,
			        exportUrl: 'feed_out_ware!exportFile'
             }
