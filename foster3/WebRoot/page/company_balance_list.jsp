        ...
        $(function () {
	   	   	        	  ...
	   	   	        	  { text: '修改', icon: 'modify' ,expression:'!=1', disabled:true, click: function(item) {
            	   	    		...
            	   	    		if (selectedRow.length == 0) {
           	   	    			...
           	   	    			$.ligerDialog.open({
           							...
           							height: 320,
                   	   				width: 380,  
           							url: 'company_balance!loadUpdateById?id='+selectedRow[0]['id'],
           							buttons: [
           				                {text:'确定',onclick: function(item, dialog) {
           				                	var data = dialog.frame.onSave();
              				       	    	if(data!=null){
              				       				$.ligerui.ligerAjax({
              				       					url:"company_balance!modify",
              				       					dataType:"text",
              				       					data:data,
			   	   	            ...
			   	   	            $.ligerDialog.confirm('确认要撤销结算吗?', function(data) {
		   	          				...
		   	          				if(data){
		 	   	          				$.ligerui.ligerAjax({
	 		      							type: "POST",
	 		      							async:  false,
	 		      							url: "company_balance!cancelCheck",
	 		      							data: { id: id },
	 		      							dataType: "text",
	 		      							success: function(result, status){
	 		      								if(result != ""){
        	 ...
        	 var gridoption={
                     columns:[
              		...
              		url:'company_balance!loadByPage'
             }
