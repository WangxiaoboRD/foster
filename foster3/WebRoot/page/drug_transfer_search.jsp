    ...
    <script type="text/javascript">
        ...
        $(function () {
        	 form = {
                 ...
                 space: 20,
                 fields:[
					 { display: "批次编码", name: "e.batch.id", type: "hidden"},
    	 			 { display: "药品类型", name:"e.drug.drugType", type:"select" ,comboboxName: 'drugType', options:{
							data: [{ text: '疫苗', id: '1' },
        			               { text: '药品', id: '0' }],
					 }},
    	 			 { display: "名称",labelWidth: 37, name: "e.drug.name", type: "text",width:100 },
        	 ...
        	 var gridoption={
                     columns:[
                        ...
                        { display: '药品类型',name: 'drug.drugType',hide:true,width:90,render:function(data){
