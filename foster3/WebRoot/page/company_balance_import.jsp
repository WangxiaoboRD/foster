        ...
        $(function(){
    		...
    		var toolBarOption = { 
				  ...
				  { text: '模板下载', icon: 'down', click: function() {
					  $.download($('form'), 'company_balance!downloadTemplate');
				  }}
			  ]
        	 };
	  		 var formOption = {
	  		 	 url: "company_balance!importFile",	// 此处也是必须的
	  			 labelWidth: 100, 
	  			 fileUpload: true, 
           		 space:20,
	  			 fields: [
              	 ...
              	 buttons:[
 					 { text: '上传', icon: '../ligerUI/ligerUI/skins/icons/up.gif', click: function(item){
 						...
 						$.ajaxFileUpload({
				    		 url: 'company_balance!importFile',
				    		 secureuri: false,
				    		 fileElementId: 'doc',
				    		 dataType: "json",
	  		 ...
	  		 var gridOption={
                     ...
                     columns:[
	                     ...
	                     { display: '结算日期', name: 'registDate'},
	                     { display: '公司结算单', name: 'id'},
              		]
             }
