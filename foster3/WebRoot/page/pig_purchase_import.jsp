        ...
        $(function(){
    		...
    		var toolBarOption = { 
				  ...
				  { text: '模板下载', icon: 'down', click: function() {
					  $.download($('form'), 'pig_purchase!downloadTemplate');
				  }}
			  ]
        	 };
	  		 var formOption = {
	  		 	 url: "pig_purchase!importFile",	// 此处也是必须的
	  			 labelWidth: 100, 
	  			 fileUpload: true, 
           		 space:20,
	  			 fields: [
