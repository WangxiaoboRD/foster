        ...
        $(function () {
        	   ...
        	   var toolBarOption = { 
   	                   items: [
							 ...
							 $.pap.addTabItem({ 
		   	    	        	tabid: 'feedTransferModify'+grid.selected[0]['id'],
			   	    	        text: '饲料转接单/修改', 
			   	    	        url: 'feed_transfer!loadUpdateById?id='+grid.selected[0]['id']
			   	    	     });
	   	   			      }},
	   	   	              { line:true },
	   	   	              ...
	   	   	              { text: '查看', icon: 'view', expression:'!=1', disabled:true, click: function(item){
		   	    				...
		   	    				$.pap.addTabItem({ 
			   	    				tabid: 'feedTransfer'+grid.selected[0]['id'],
		   	   	    				text: '饲料转接单【'+grid.selected[0]['id']+'】',
		       	   					params:{ 'ids':ids,'id':grid.selected[0]['id']},
		   	   	    				url: 'feed_transfer!loadDetailById?id='+grid.selected[0]['id']
		   	   	    			});
	   	   			      }},
	   	   				  { line:true },
        	 ...
        	 var gridoption={
                    ...
                    url:'feed_transfer!loadByPage',
                    exportBtn: true,
			        exportUrl: 'feed_transfer!exportFile'
             }
