  	  	  ...
  	  	  toolbar = $("#toolbar").ligerToolBar({ 
                items: [
     	            ...
     	            { text: '上一单', icon: 'up', click: function(item){
     	                 ...
     	                 for(var i=0;i<ids.length;i++){
     	                    if(ids[i]==id){
    		  			    ...
    		  			    $.pap.addTabItem({ 
    		  			 		tabid:'viewCompanSaleOrder'+infoId,
      	   	    				text: '公司销售【'+infoId+'】',
          	   					params:{ 'ids':ids,'id':infoId},
      	   	    				url: 'company_sale!loadDetailById?id='+infoId
      	   	    		});
      	   	    		$.pap.removeTabItem();
     			     }},
                     { line:true },
  	  	     ...
  	  	     form =$("#form0").ligerForm({
          		 ...
          		 space:20,
	  			 fields: [
					{display: "销售单号", name: "e.id", type: "text",options:{value:'${e.id}',readonly:true},group: "公司销售单", groupicon: groupicon},
					{display: "销售日期", name: "e.registDate", type: "date",group: "销售信息", groupicon: groupicon,options: {value:'${e.registDate}',readonly:true}},
	                ...
	                {display: "销售商", name:"e.buyer.name",type:"text",options:{value:'${e.buyer.name}',readonly:true}},
					{display: "销售头数（头）", name: "e.quantity",group: "销售费用", groupicon: groupicon, type: "number",newline: true,options:{readonly:true,value:'${e.quantity}'}},
					{display: "销售重量（KG）", name: "e.weight", type: "number",options:{readonly:true,value:'${e.weight}'}},
					{display: "销售金额（元）", name: "e.amount", type: "number",newline: true,options:{readonly:true,value:'${e.amount}'}},
					{display: "运输费用（元）", name: "e.tcost", type: "number",options:{readonly:true,value:'${e.tcost}'}},
