                 ...
                 { text: '关闭', icon: 'delete', click: function(item){
                  ...
                  { line:true },
 	              { text: '上一单', icon: 'up', click: function(item){
		  			...
		  			$.pap.addTabItem({ 
		  			 		tabid:'viewDrugTransfer'+infoId,
  	   	    				text: '药品转接单【'+infoId+'】',
      	   					params:{ 'ids':ids,'id':infoId},
  	   	    				url: 'drug_transfer!loadDetailById?id='+infoId
  	   	    		});
  	   	    		$.pap.removeTabItem();
 			      }},
                  { line:true },
          	...
          	var groupicon = "../ligerUI/ligerUI/skins/icons/communication.gif";
	  		 var formOption = {
	  			 ...
	  			 inputWidth: 170,
           		 space:20,
	  			 fields: [
  			        { display: "转接单号", name: "e.id", type: "text",  options: { value: '${e.id}', readonly: true }, group: "药品转接单", groupicon: groupicon },
					...
					{ display: "转入批次",name: "e.inBatch.id", newline:true,type: "text",options:{readonly:true,value: '${e.inBatch.batchNumber}'}},
	  		 ...
	  		 var gridOption={
	  				url:'drug_transfer_dtl!loadByEntity',
	        		parms:{ 'e.drugTransfer.id': '${e.id}' },
                    columns:[
