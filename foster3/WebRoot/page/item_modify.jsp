	  ...
	  $(function(){
		  //生成ligerUI form
	  	 form = $("form").ligerForm({
             ...
             fields: [
				{ display: "功能编码", name: "e.id",newline: true, type: "hidden",options:{value:'${e.id}'} },
             	{ display: "子栏目数", name: "e.childrens",newline: true, type: "hidden",options:{value:'${e.childrens}'} }, 
                { display: "功能名称", name: "e.itemName",validate:{required:true},newline: true, type: "text",options:{value:'${e.itemName}'}}, 
                ...
                { display: "URL", name: "e.url",newline: true, type: "text",options:{value:'${e.url}'}}, 
                { display: "参数", name: "e.urlParam",newline: true, type: "text",options:{value:'${e.urlParam}'} }, 
                { display: "方法名", name: "e.functionName",newline: true, type: "text",options:{value:'${e.functionName}'}}, 
                ...
                { display :'功能序号',name:'e.rank',type:'spinner',newline: true,options:{type: 'int',isNegative:false, minValue: 0, maxValue: 1000000,step:1,value:'${e.rank}'}},
                { display :'功能描述',name:'e.itemDesc',type:'textarea',newline: true,options:{width:168,value:'${e.itemDesc}'}}
                ]
	  		 });
	  		 v= form.validateForm();
	  	});
