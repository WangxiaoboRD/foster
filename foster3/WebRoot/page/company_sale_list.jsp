        ...
        $(function () {
   	                   ...
   	                   items: [
	   	   	        	  ...
	   	   	        	  { text: '修改', icon: 'modify' ,expression:'!=1', disabled:true, click: function(item) {
            	   	    		...
            	   	    		if (selectedRow.length == 0) {
           	   	    			...
           	   	    			$.ligerDialog.open({
           							...
           							height: 420,
                   	   				width: 380,  
           							url: 'company_sale!loadUpdateById?id='+grid.selected[0]['id'],
           							buttons: [
           				                {text:'确定',onclick: function(item, dialog) {
           				                	var data = dialog.frame.onSave();
              				       	    	if(data!=null){
              				       				$.ligerui.ligerAjax({
              				       					url:"company_sale!modify",
              				       					dataType:"text",
              				       					data:data,
		   			      ...
		   			      { text: '撤销', icon: 'back', expression:'!=1', disabled: true, click: function(item){
		   	   	           ...
		   	   	           { text: '查看', icon: 'view', expression:'!=1', disabled:true, click: function(item){
		   	    				...
		   	    				$.pap.addTabItem({ 
			   	    				tabid: 'companySaleOrder'+grid.selected[0]['id'],
		   	   	    				text: '公司销售【'+grid.selected[0]['id']+'】',
		       	   					params:{ 'ids':ids,'id':grid.selected[0]['id']},
		   	   	    				url: 'company_sale!loadDetailById?id='+grid.selected[0]['id']
		   	   	    			});
		   	   			   }}
                    ]
             	};
        	 ...
        	 form = {
                 ...
                 fields:[
						...
						{ display: "所属批次", name:"e.batch.id",comboboxName: 'batch', type:"select",options:{
	        	 	 	...
	        	 	 	{ display: "销售日期", name: "e.tempStack.startTime", type: "date", space: 10,options: {format : "yyyy-MM-dd"}},
        	 ...
        	 var gridoption={
                     columns:[
	    				...
	    				{ display: '销售总数（头）', name: 'quantity',width:65},
	    				{ display: '销售重量（公斤）', name: 'weight',width:100},
	    				{ display: '销售金额（元）', name: 'amount',width:90},
	    				{ display: '运输费用', name: 'tcost',width:90},
	    				{ display: '销售商', name: 'buyer.name',width:90},
              		...
              		url:'company_sale!loadByPage',
                    exportBtn: true,
			        exportUrl: 'company_sale!exportFile'
             }
