                 ...
                 { text: '关闭', icon: 'delete', click: function(item){
                  ...
                  { line:true },
 	              { text: '上一单', icon: 'up', click: function(item){
		  			...
		  			$.pap.addTabItem({ 
		  			 		tabid:'viewDrugOutWare'+infoId,
  	   	    				text: '药品出库单【'+infoId+'】',
      	   					params:{ 'ids':ids,'id':infoId},
  	   	    				url: 'drug_out_ware!loadDetailById?id='+infoId
  	   	    		});
  	   	    		$.pap.removeTabItem();
 			      }},
                  { line:true },
          	...
          	var groupicon = "../ligerUI/ligerUI/skins/icons/communication.gif";
	  		 var formOption = {
	  			 ...
	  			 inputWidth: 170,
           		 space:20,
	  			 fields: [
  			        { display: "出库单号", name: "e.id", type: "text",  options: { value: '${e.id}', readonly: true }, group: "药品出库单", groupicon: groupicon },	  		  			 
					...
					{ display: "领药单",name: "e.drugBill", type: "text",options:{readonly:true,value: '${e.drugBill}'}},
	  		 ...
	  		 var gridOption={
	  				url:'drug_out_ware_dtl!loadByEntity',
	        		parms:{ 'e.drugOutWare.id': '${e.id}' },
                    columns:[
