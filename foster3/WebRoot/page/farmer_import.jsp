        ...
        $(function(){
    		...
    		var toolBarOption = { 
				  ...
				  { text: '模板下载', icon: 'down', click: function() {
					  $.download($('form'), 'farmer!downloadTemplate');
				  }}
			  ]
        	 };
	  		 var formOption = {
	  		 	 url: "farmer!importFile",	// 此处也是必须的
	  			 labelWidth: 100, 
	  			 fileUpload: true, 
           		 space:20,
	  			 fields: [
	  		 ...
	  		 var gridOption={
                     ...
                     columns:[
	                     ...
	                     { display: '家庭地址', name: 'homeAddress'},
	                     { display: '园区面积(m²)', name: 'farmArea'},
	                     { display: '猪舍栋数', name: 'piggeryQuan'},
	                     { display: '园区地址', name: 'farmAddress'},
	                     { display: '养殖规模', name: 'breedQuan'},
