...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function(){
	  		 var formOption = {
	  		 	 url: "drug_transfer!modifyAll",	// 此处也是必须的
	  			 labelWidth: 85, 
	  			 inputWidth: 170,
           		 space:20,
	  			 fields: [
	  			    { display: "转接单号", name: "e.id", type: "text", validate: { required: true }, options: { value: '${e.id}', readonly: true }, group: "药品转接单", groupicon: groupicon },	  		  			 
					...
					{ display: "转入批次", name: "e.inBatch.id",comboboxName: 'inBatch', type: "select",options:{
					 ...
					 { display: "备注",newline:true, name: "e.remark", type: "text",width:450,options: { value: '${e.remark}'}},
					 ]};
	  		   var oldNum=0;
	  		   var oldSubNum=0;
  	  		   var gridOption={
