    ...
    <script type="text/javascript">
        ...
        $(function () {
        	   ...
        	   var toolBarOption = { 
   	                   items: [
	   	                  { text: '新增', icon: 'add', click: function() {
		   	    	         ...
		   	    	         $.pap.addTabItem({ 
			   	    	         text: '权限字段/修改', 
			   	    	         url: 'auth_field!loadUpdateById?id='+grid.selected[0]['code'],
			   	    	         param:selectedRow 
			   	    	      });
	   	   	              ...
	   	   	              { text: '查看', icon: 'view', expression:'!=1', disabled:true, click: function(item){
		   	    				...
		   	    				$.pap.addTabItem({ 
		   	   	    				text: '权限字段/查看', 
		   	   	    				url: 'auth_field!loadDetailById?id='+grid.selected[0]['code'],
		   	   	    				//param: selectedRow 
		   	   	    			});
	   	   			      }}
                   		]
        	 ...
        	 form = {
                	 labelWidth: 100,
                     fields:[
                         { display: "权限字段编码", name: "e.code", type: "text" } ,
        	 			 { display: "权限字段名称", name: "e.name", type: "text" },
       	 				 { display: "权限字段类型", name: "e.type", type: "select", comboboxName: 'typeName', options:{
        	 				  keySupport:true,
      	                	  data: [
       	                	    { text: '---', id: '' },
