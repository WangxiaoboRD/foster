          ...
          var toolBarOption = { 
                 ...
                 { text: '关闭', icon: 'delete', click: function(item){
                  ...
                  { line:true },
 	              { text: '上一单', icon: 'up', click: function(item){
		  			...
		  			$.pap.addTabItem({ 
		  			 		tabid:'viewMedicalBill'+infoId,
  	   	    				text: '耗药单【'+infoId+'】',
      	   					params:{ 'ids':ids,'id':infoId},
  	   	    				url: 'medical_bill!loadDetailById?id='+infoId
  	   	    		});
  	   	    		$.pap.removeTabItem();
 			      }},
                  { line:true },
	  		 ...
	  		 var formOption = {
	  			 ...
	  			 inputWidth: 170,
           		 space:20,
	  			 fields: [
  			        { display: "耗药单号", name: "e.id", type: "text",  options: { value: '${e.id}', readonly: true }, group: "药品耗用单", groupicon: groupicon },	  		  			 
					...
					{ display: "耗药时间", name: "e.registDate", type: "date", options: { value: '${e.registDate}', showTime: true ,readonly: true}},
				    ...
				    { display: "备注", newline: true,name: "e.remark", type: "text",width:450,options: { readonly:true,value: '${e.remark}'}}
					
               ]};

	  		 var gridOption={
	  				url:'medical_bill_dtl!loadByEntity',
	        		parms:{ 'e.medicalBill.id': '${e.id}' },
                    columns:[
		    				...
		    				{ display: "原因", name: 'reason',width:250},
