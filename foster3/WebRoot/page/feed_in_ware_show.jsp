                 ...
                 { text: '关闭', icon: 'delete', click: function(item){
                  ...
                  { line:true },
 	              { text: '上一单', icon: 'up', click: function(item){
		  			...
		  			$.pap.addTabItem({ 
		  			 		tabid:'viewFeedInWare'+infoId,
  	   	    				text: '领料单【'+infoId+'】',
      	   					params:{ 'ids':ids,'id':infoId},
  	   	    				url: 'feed_in_ware!loadDetailById?id='+infoId
  	   	    		});
  	   	    		$.pap.removeTabItem();
 			      }},
                  { line:true },
          	...
          	var groupicon = "../ligerUI/ligerUI/skins/icons/communication.gif";
	  		 var formOption = {
	  			 ...
	  			 inputWidth: 170,
           		 space:20,
	  			 fields: [
  			        { display: "领料单号", name: "e.id", type: "text",  options: { value: '${e.id}', readonly: true }, group: "饲料领用单", groupicon: groupicon },	  		  			 
					...
					{ display: "领料时间", name: "e.registDate", type: "date", options: { value: '${e.registDate}', showTime: true ,readonly: true}},
				    ...
				    { display: "发货单号", name: "e.invoiceCode", type: "text",options:{readonly:true,value: '${e.invoiceCode}'}},
				    { display: "备&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;注", name: "e.remark", type: "text",options: { readonly:true,value: '${e.remark}'},width:450}
