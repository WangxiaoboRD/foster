        ...
        $(function () {
        	 form = {
                 ...
                 fields:[
					 ...
					 { display: "饲料厂id", name: "e.feedFac.id", type: "hidden"},
    	 			 { display: "药品类型",width:100, name:"e.drug.drugType", type:"select" ,comboboxName: 'drugType', options:{
							data: [{ text: '疫苗', id: '1' },
        			               { text: '药品', id: '0' }],
					 }},
    	 			 { display: "名称",labelWidth: 37, name: "e.drug.name",width:100, type: "text" },
    	 			 { display: "编码", labelWidth: 37,name: "e.drug.code", type: "text",width:200 }
	    			]
            	}
        	 var gridoption={
                     columns:[
              		...
              		usePager: false,
                    url:'drug_warehouse!loadByCodes'
             }
