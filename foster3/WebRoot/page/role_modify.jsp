	  	...
	  	var currentParam = currentPage.getParam("param")[0];
  		 var formOption = {
  			 ...
  			 fields: [
                ...
                { display: "所属公司", name: "e.company.id", type: "hidden" ,options: {value: "${e.company.id}"}},
                { display: "所属公司", name: "e.company.name", type: "text", newline: true, options: { readonly:true,value: "${e.company.name}"}},
