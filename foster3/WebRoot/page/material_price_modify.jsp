...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function(){
	  		 var formOption = {
	  		 	 url: "material_price!modifyAll",	// 此处也是必须的
	  			 labelWidth: 85, 
	  			 inputWidth: 170,
           		 space:20,
	  			 fields: [
					{ display: "物料定价单", name: "e.id", type: "text", validate: { required: true }, options: { value: '${e.id}', readonly: true }, group: "物料定价单", groupicon: groupicon },	  		  			 
