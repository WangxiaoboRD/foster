        ...
        $(function () {
        	   ...
        	   var toolBarOption = { 
   	                   items: [
							 ...
							 $.pap.addTabItem({ 
	   	   	            	   	tabid: 'eliminateBillAdd',
   	   	      			  	   	text: '淘汰单/新增',
   	   	      			 	   	url: 'eliminate_bill_add.jsp'
   	   	       			     });
	   	   	              }},
	   	   	              { line:true },
							 ...
							 $.pap.addTabItem({ 
		   	    	        	tabid: 'eliminateBillModify'+grid.selected[0]['id'],
			   	    	        text: '淘汰单/修改', 
			   	    	        url: 'eliminate_bill!loadUpdateById?id='+grid.selected[0]['id']
			   	    	     });
	   	   			      }},
	   	   	              { line:true },
	   	   	              ...
	   	   	              { text: '查看', icon: 'view', expression:'!=1', disabled:true, click: function(item){
		   	    				...
		   	    				$.pap.addTabItem({ 
			   	    				tabid: 'eliminateBill'+grid.selected[0]['id'],
		   	   	    				text: '淘汰单【'+grid.selected[0]['id']+'】',
		       	   					params:{ 'ids':ids,'id':grid.selected[0]['id']},
		   	   	    				url: 'eliminate_bill!loadDetailById?id='+grid.selected[0]['id']
		   	   	    			});
	   	   			      }},
	   	   				  { line:true },
			   	   	            ...
			   	   	            $.ligerDialog.confirm('确认要撤销该单据吗?', function(data) {
	 	   	          				if(data){
		 	   	          				$.ligerui.ligerAjax({
	   		      							type: "POST",
	   		      							async:  false,
	   		      							url: "eliminate_bill!cancelCheck",
	   		      							data: { id: selData['id'] },
	   		      							dataType: "text",
	   		      							success: function(result, status){
	   		      								if(result != ""){
        	 ...
        	 form = {
                 labelWidth: 70,
                 fields:[
						{ display: "淘汰单号", name:"e.id", type:"text" },
						...
						{ display: "淘汰时间", name: "e.tempStack.startTime", type: "date", space: 10 },
        	 ...
        	 var gridoption={
                    ...
                    url:'eliminate_bill!loadByPage',
                    exportBtn: true,
			        exportUrl: 'eliminate_bill!exportFile'
             }
