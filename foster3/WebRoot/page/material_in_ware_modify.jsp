...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function(){
	  		 var formOption = {
	  		 	 url: "material_in_ware!modifyAll",	// 此处也是必须的
	  			 labelWidth: 85, 
	  			 inputWidth: 170,
           		 space:20,
	  			 fields: [
	  			    { display: "入库单号", name: "e.id", type: "text", validate: { required: true }, options: { value: '${e.id}', readonly: true }, group: "物料入库单", groupicon: groupicon },	  		  			 
					...
					{ display: "备&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;注", newline,name: "e.remark", type: "text",width:450,options: { value: '${e.remark}'}},
					 ]};
	  		   var oldNum=0;
	  		   var oldSubNum=0;
  	  		   var gridOption={
