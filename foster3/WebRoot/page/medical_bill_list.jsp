        ...
        $(function () {
        	   ...
        	   var toolBarOption = { 
   	                   items: [
							 ...
							 $.pap.addTabItem({ 
	   	   	            	   	tabid: 'medicalBillAdd',
   	   	      			  	   	text: '耗药单/新增',
   	   	      			 	   	url: 'medical_bill_add.jsp'
   	   	       			     });
	   	   	              }},
	   	   	              { line:true },
							 ...
							 $.pap.addTabItem({ 
		   	    	        	tabid: 'medicalBillModify'+grid.selected[0]['id'],
			   	    	        text: '耗药单/修改', 
			   	    	        url: 'medical_bill!loadUpdateById?id='+grid.selected[0]['id']
			   	    	     });
	   	   			      }},
	   	   	              { line:true },
	   	   	              ...
	   	   	              { text: '查看', icon: 'view', expression:'!=1', disabled:true, click: function(item){
		   	    				...
		   	    				$.pap.addTabItem({ 
			   	    				tabid: 'medicalBill'+grid.selected[0]['id'],
		   	   	    				text: '领药单【'+grid.selected[0]['id']+'】',
		       	   					params:{ 'ids':ids,'id':grid.selected[0]['id']},
		   	   	    				url: 'medical_bill!loadDetailById?id='+grid.selected[0]['id']
		   	   	    			});
	   	   			      }},
	   	   				  { line:true },
        	 ...
        	 form = {
                 labelWidth: 70,
                 fields:[
						{ display: "耗药单号", name:"e.id", type:"text" },
						...
						{ display: "耗药时间", name: "e.tempStack.startTime", type: "date", space: 10 },
        	 ...
        	 var gridoption={
                    ...
                    url:'medical_bill!loadByPage',
                    exportBtn: true,
			        exportUrl: 'medical_bill!exportFile'
             }
