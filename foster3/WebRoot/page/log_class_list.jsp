        ...
        $(function () {
                 		    	...
                 		    	if(! jQuery.isEmptyObject(grid.selected) ){
                 	   	    		if(grid.selected.length > 1){
                 	   	    			...
                 	   	    			$.ligerDialog.open({
                 							...
                 							width:350,
                 							height:280, 
                 							url: 'log_class!loadUpdateById?id='+grid.selected[0]['id'],
                 							buttons: [
                 				                {text:'确定',onclick: function(item, dialog) {
                 				                	var data = dialog.frame.onSave();
	                 				       	    	if(data!=null){
	                 				       				$.ligerui.ligerAjax({
	                 				       					url:"log_class!modifyAll",
	                 				       					dataType:"text",
	                 				       					data:data,
        	 ...
        	 var gridoption={
                     columns:[
	    				...
	    				{ display: '类名称', name: 'className', width: 150 },
	    				{ display: '创建人', name: 'createUser', width: 150 },
	    				{ display: '创建时间', name: 'createDate', width: 150 }
              		],
                    url:'log_class!loadByPage',
                    exportBtn: true,
			        exportUrl: 'log_class!exportFile'
             }
