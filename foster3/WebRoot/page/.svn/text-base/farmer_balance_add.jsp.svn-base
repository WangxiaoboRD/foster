	  ...
	  $(function(){
		 var groupicon = "../ligerUI/ligerUI/skins/icons/communication.gif";
	  	 form = $("form").ligerForm({
             ...
             fields: [
					{display: "结算日期", name: "e.registDate", type: "date",validate: {required:true},group: "代养结算单", groupicon: groupicon,options: {value:new Date(),format:"yyyy-MM-dd",alwayShowInDown: true }},
