    ...
    <script type="text/javascript">
        ...
        $(function(){
        	 toolbar = $("#toolbar").ligerToolBar({
             	items: [
               	   { text: '保存', icon: 'add', click: function(){
        	...
        	form =$("#form0").ligerForm({
	  			 ...
	  			 inputWidth: 170,
           		 space:20,
	  			 fields: [
					{ display: "代养农户", name:"e.farmer.id", type:"select",comboboxName:'farmer',group: "养殖合同", groupicon: groupicon,validate: { required: true }, options:{
