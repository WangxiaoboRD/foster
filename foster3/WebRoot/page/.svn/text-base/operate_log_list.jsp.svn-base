...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {     
		     ...
		     var form={
		      	  inputWidth: 130, labelWidth: 80, space:20,
	              fields:[
	          ...
	          var gridoption={
	          		url:'operate_log!loadByPage',
	          		title:'操作日志',
	               	columns:[
	    				{display:'日志编码',name:'code',width:100},
	    				{display:'操作人编码',name:'operateUserCode',width:150},
	    				{display:'操作模块',name:'operateModel',width:200},
	    				{display:'操作方法',name:'operateType',width:150},
	    				{display:'操作人IP',name:'ip',width:150},
	    				{display:'操作日期',name:'operateDate',width:200}
	    			]
	          }
