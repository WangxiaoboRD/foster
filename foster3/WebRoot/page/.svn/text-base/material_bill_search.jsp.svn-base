        ...
        $(function () {
        	 form = {
                 ...
                 fields:[
					 ...
					 { display: "代养户id", name: "e.farmer", type: "hidden"},
    	 			 { display: "名称", name: "e.material.name", type: "text" },
    	 			 { display: "编码", name: "e.material.code", type: "text" },
	    			]
            	}
        	 var gridoption={
                     columns:[
                        { display: '物料id',name: 'material.id',hide:true},
                        { display: '物料编码',name: 'material.code',width:90},
                        { display: '物料名称',name: 'material.name',width:90},
	    				{ display: '物料规格',name: 'material.spec',width:90},
	    				{ display: '数量',name: 'quantity',width:90},
	    				{ display: '单位',name: 'material.unit.value',width:90},
	    				/**
	    				{ display: '副单位数量',name: 'subQuantity',width:90},
	    				{ display: '副单位',name: 'material.subUnit.value',width:90},
	    				*/
