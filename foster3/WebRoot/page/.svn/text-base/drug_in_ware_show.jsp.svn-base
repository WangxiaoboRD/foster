                 ...
                 { text: '关闭', icon: 'delete', click: function(item){
                  ...
                  { line:true },
 	              { text: '上一单', icon: 'up', click: function(item){
		  			...
		  			$.pap.addTabItem({ 
		  			 		tabid:'viewDrugInWare'+infoId,
  	   	    				text: '药品入库单【'+infoId+'】',
      	   					params:{ 'ids':ids,'id':infoId},
  	   	    				url: 'drug_in_ware!loadDetailById?id='+infoId
  	   	    		});
  	   	    		$.pap.removeTabItem();
 			      }},
                  { line:true },
          	...
          	var groupicon = "../ligerUI/ligerUI/skins/icons/communication.gif";
	  		 var formOption = {
	  			 ...
	  			 inputWidth: 170,
           		 space:20,
	  			 fields: [
  			        { display: "入库单号", name: "e.id", type: "text",  options: { value: '${e.id}', readonly: true }, group: "药品入库单", groupicon: groupicon },	  		  			 
					{ display: "养殖公司", name:"e.company.id",type: "text", options:{value: '${e.company.name}',readonly: true},group: "单据信息", groupicon: groupicon},
					{ display: "饲料厂", name:"e.feedFac.name",type: "text", options:{value: '${e.feedFac.name}',readonly: true}},
