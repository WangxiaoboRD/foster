    ...
    <script type="text/javascript">
        ...
        $(function(){
            ...
            form = $("form").ligerForm({
   	  		 	 ...
   	  		 	 space: 20,
	  			 fields: [
					{ display: "规则编号", name: "e.id", options: { value: '${e.id}' }, type: "text", hidden: true },
					...
					{ display: '生成日期', name: "e.execDate", type: "date", options: { value: '${e.execDate}' }},
	                ...
	                { display: '号码数量', name: "e.numberNum", type: "text", options: { digits: true, value: '${e.numberNum}' }, validate: { required: true }, newline: true }
               	 ]
        	});
