          ...
          var toolBarOption = { 
                 ...
                 { text: '关闭', icon: 'delete', click: function(item){
                  ...
                  { line:true },
 	              { text: '上一单', icon: 'up', click: function(item){
		  			...
		  			$.pap.addTabItem({ 
		  			 		tabid:'viewEliminateBill'+infoId,
  	   	    				text: '淘汰单【'+infoId+'】',
      	   					params:{ 'ids':ids,'id':infoId},
  	   	    				url: 'eliminate_bill!loadDetailById?id='+infoId
  	   	    		});
  	   	    		$.pap.removeTabItem();
 			      }},
                  { line:true },
	  		 ...
	  		 var formOption = {
	  			 ...
	  			 inputWidth: 170,
           		 space:20,
	  			 fields: [
  			        { display: "淘汰单号", name: "e.id", type: "text",  options: { value: '${e.id}', readonly: true }, group: "淘汰单", groupicon: groupicon },	  		  			 
					...
					{ display: "淘汰时间", name: "e.registDate", type: "date",newline:true, options: { value: '${e.registDate}', showTime: true ,readonly: true}},
