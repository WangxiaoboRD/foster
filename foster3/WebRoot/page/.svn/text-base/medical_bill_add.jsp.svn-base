...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function(){
	  		 var formOption = {
	  		 	 url: "medical_bill!save",	// 此处也是必须的
	  			 labelWidth: 85, 
	  			 inputWidth: 170,
           		 space:20,
           		 excludeClearFields:['e.remark','e.registDate','farmer','batch',],
	  			 fields: [
					{ display: "登记时间", name: "e.registDate", type: "date",group: "药品耗用单", groupicon: groupicon,validate: { required: true },options: { value: new Date(), showTime: false }},
