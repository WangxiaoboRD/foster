        ...
        $(function () {
        	   ...
        	   var toolBarOption = { 
   	                   items: [
							 ...
							 $.pap.addTabItem({ 
		   	    	        	tabid: 'drugInWareModify'+grid.selected[0]['id'],
			   	    	        text: '药品入库单/修改', 
			   	    	        url: 'drug_in_ware!loadUpdateById?id='+grid.selected[0]['id']
			   	    	     });
	   	   			      }},
	   	   	              { line:true },
	   	   	              ...
	   	   	              { text: '查看', icon: 'view', expression:'!=1', disabled:true, click: function(item){
		   	    				...
		   	    				$.pap.addTabItem({ 
			   	    				tabid: 'drugInWare'+grid.selected[0]['id'],
		   	   	    				text: '药品入库单【'+grid.selected[0]['id']+'】',
		       	   					params:{ 'ids':ids,'id':grid.selected[0]['id']},
		   	   	    				url: 'drug_in_ware!loadDetailById?id='+grid.selected[0]['id']
		   	   	    			});
	   	   			      }},
	   	   				  { line:true },
        	 ...
        	 var gridoption={
                     columns:[
	    				...
	    				{ display: '所属饲料厂',name: 'feedFac.name', width: 120 },
                    ...
                    url:'drug_in_ware!loadByPage',
                    exportBtn: true,
			        exportUrl: 'drug_in_ware!exportFile'
             }
