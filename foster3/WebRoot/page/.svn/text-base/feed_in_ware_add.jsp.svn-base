...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function(){
	  		 var formOption = {
	  		 	 url: "feed_in_ware!save",	// 此处也是必须的
	  			 labelWidth: 85, 
	  			 inputWidth: 170,
           		 space:20,
           		 excludeClearFields:['e.remark','e.invoiceCode','e.registDate','driver','transportCo','farmer','batch'],
	  			 fields: [
					{ display: "代&nbsp;养&nbsp;户", name:"e.farmer.id",group: "饲料领用单", groupicon: groupicon,comboboxName: 'farmer',type:"select",validate:{ required:true },options:{
					...
					{ display: "领料时间", name: "e.registDate",newline: true, type: "date",validate: { required: true },options: { value: new Date(), showTime: false }},
					{ display: "发货单号", name: "e.invoiceCode", type: "text",width:170},
