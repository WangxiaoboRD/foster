        ...
        $(function () {
            ...
            $("#form0").ligerForm({
                fields: [
					...
					{ display: "登记时间",validate: { required: true }, name: "e.registDate", type: "date",options:{value: new Date(),format : "yyyy-MM-dd",showTime: true}},
					{ display: "备&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;注",newline: true, name: "e.remark", type: "text",width:490}
            ...
            gridarea = $("#form1").ligerGrid({
                 ...
                 columns:[
                        { display: '日龄(天)', name: 'days', editor: { type: 'text', options: {digits: true,initSelect: true }}},
                        { display: '标准体重(kg)', name: 'standWeight', editor: { type: 'text', options: {initSelect: true }}},
                        { display: '饲料阶段', name: 'feedType.id', textField: 'feedType.name', width: 180, editor: { type: 'select',
                 		...
                 		{ display: '饲喂量(kg)', name: 'feedWeight', editor: { type: 'text', options: {initSelect: true }}}
