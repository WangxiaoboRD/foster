        ...
        $(function () {
        	   ...
        	   var toolBarOption = { 
   	                   items: [
							 ...
							 $.pap.addTabItem({ 
		   	    	        	tabid: 'feedInWareModify'+grid.selected[0]['id'],
			   	    	        text: '领料单/修改', 
			   	    	        url: 'feed_in_ware!loadUpdateById?id='+grid.selected[0]['id']
			   	    	     });
	   	   			      }},
	   	   	              { line:true },
	   	   	              ...
	   	   	              { text: '查看', icon: 'view', expression:'!=1', disabled:true, click: function(item){
		   	    				...
		   	    				$.pap.addTabItem({ 
			   	    				tabid: 'feedInWare'+grid.selected[0]['id'],
		   	   	    				text: '领料单【'+grid.selected[0]['id']+'】',
		       	   					params:{ 'ids':ids,'id':grid.selected[0]['id']},
		   	   	    				url: 'feed_in_ware!loadDetailById?id='+grid.selected[0]['id']
		   	   	    			});
	   	   			      }},
	   	   				  { line:true },
	 	   			      ...
	 	   			      { text: '撤销', icon: 'back', expression:'!=1', disabled: true, click: function(item){
					            ...
					            if (selData['checkStatus'] != '1') {
				 	     	    ...
				 	     	    if (!(selData['feedTransfer'] ==null || selData['feedTransfer']=='')) {
        	 ...
        	 form = {
                 labelWidth: 70,
                 fields:[
						{ display: "领料单号", name:"e.id", type:"text" },
						...
						{ display: "领料时间", name: "e.tempStack.startTime", type: "date", space: 10 },
        	 ...
        	 var gridoption={
                     columns:[
                        { display: '领料单号',name: 'id',width:90},
	    				{ display: '养殖公司',name: 'company.name',width:110},
	    				{ display: '代养户',name: 'farmer.name',width:110 },
	    				{ display: '领料时间',name: 'registDate',width:100},
	    				{ display: '运输公司',name: 'transportCoName',width:100},
	    				{ display: '司机',name: 'driverName',width:100},
                    ...
                    url:'feed_in_ware!loadByPage',
                    exportBtn: true,
			        exportUrl: 'feed_in_ware!exportFile'
             }
