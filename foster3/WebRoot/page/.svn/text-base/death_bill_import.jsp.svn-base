        ...
        $(function(){
    		...
    		var toolBarOption = { 
				  ...
				  { text: '模板下载', icon: 'down', click: function() {
					  $.download($('form'), 'death_bill!downloadTemplate');
				  }}
			  ]
        	 };
	  		 var formOption = {
	  		 	 url: "death_bill!importFile",	// 此处也是必须的
	  			 labelWidth: 100, 
	  			 fileUpload: true, 
           		 space:20,
	  			 fields: [
	  		 ...
	  		 var gridOption={
                     ...
                     columns:[
						 ...
						 { display: '死亡日期', name: 'registDate'},
						 { display: '死亡头数', name: 'totalQuan'},
						 { display: '总重量', name: 'totalWeight'},
