...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function(){
	  		 var formOption = {
	  		 	 url: "medical_bill!modifyAll",	// 此处也是必须的
	  			 labelWidth: 85, 
	  			 inputWidth: 170,
           		 space:20,
	  			 fields: [
	  			    { display: "耗药单号", name: "e.id", type: "text", validate: { required: true }, options: { value: '${e.id}', readonly: true }, group: "药品耗用单", groupicon: groupicon },	  		  			 
					...
					{ display: "耗药时间", name: "e.registDate", type: "date", validate: { required: true },newline:true,options: { value: '${e.registDate}', showTime:false }},
	  		   ...
	  		   var oldSubNum=0;
  	  		   var gridOption={
                     ...
                     columns:[
		    				...
		    				{ display: "原因", name: 'reason',width:250,editor:{type:'text'}},
