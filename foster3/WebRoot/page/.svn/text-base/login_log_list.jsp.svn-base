    ...
    <script type="text/javascript">
        ...
        $(function () {       
		      ...
		      var form={
		      	  labelWidth: 70,
	              fields:[
	                  { display: "登录账号", name: "e.userCode", type: "text" }, 
	                  { display: "登录日期", name: "e.tempStack.startDate", type: "date", options: { value: '${e.tempStack.startDate}' }, space: 10  },
	          ...
	          var gridoption={
	          		url:'login_log!loadByPage',
	          		title:'登录日志',
	               	columns:[
	    				{display:'日志编码',name:'code',width: 100 },
	    				{display:'登录人账号',name:'userCode',width: 150},
	    				{display:'登录人姓名',name:'userName',width: 150},
	    				{display:'登录人IP',name:'ip',width: 150 },
	    				{display:'登录日期',name:'loginDate',width: 200 }
	    			]
	          }
