        ...
        $(function () {
        	   ...
        	   var toolBarOption = { 
   	                   items: [
							 ...
							 $.pap.addTabItem({ 
		   	    	        	tabid: 'feedBillModify'+grid.selected[0]['id'],
			   	    	        text: '耗料单/修改', 
			   	    	        url: 'feed_bill!loadUpdateById?id='+grid.selected[0]['id']
			   	    	     });
	   	   			      }},
	   	   	              { line:true },
	   	   	              ...
	   	   	              { text: '查看', icon: 'view', expression:'!=1', disabled:true, click: function(item){
		   	    				...
		   	    				$.pap.addTabItem({ 
			   	    				tabid: 'feedBill'+grid.selected[0]['id'],
		   	   	    				text: '耗料单【'+grid.selected[0]['id']+'】',
		       	   					params:{ 'ids':ids,'id':grid.selected[0]['id']},
		   	   	    				url: 'feed_bill!loadDetailById?id='+grid.selected[0]['id']
		   	   	    			});
	   	   			      }},
	   	   				  { line:true },
	 	   			      ...
	 	   			      { text: '撤销', icon: 'back', expression:'!=1', disabled: true, click: function(item){
					            ...
					            if (selData['feedUseId']) {
					       			$.ligerDialog.warn('该单据由录入单生成，不允许撤销！');
									return;
				 	     	    }
        	 ...
        	 form = {
                 labelWidth: 70,
                 fields:[
						{ display: "耗料单号", name:"e.id", type:"text" },
						...
						{ display: "耗料时间", name: "e.tempStack.startTime", type: "date", space: 10 },
        	 ...
        	 var gridoption={
                     columns:[
	    				...
	    				{ display: '饲料录入单ID',name: 'feedUseId',hide:true}
              		],
                    url:'feed_bill!loadByPage',
                    exportBtn: true,
			        exportUrl: 'feed_bill!exportFile'
             }
...
<body>
<div id="lianjie">
 <a href="feed_bill_add.jsp">新增 </a><br/>
 <a href="feed_bill_modify.jsp">修改 </a><br/>
 <a href="feed_bill_modify.jsp">删除 </a><br/>
 <a>审核 </a><br/>
 <a>撤销</a><br/>
 </div>
 <div id="formk">
 <form action="feed_bill!loadByPage"></form>
 耗料单号:<input type="text"></input> 养殖公司:<select > <option value="内容1">下拉显示值1</option></select>
 代养户:<select><option value="内容1">下拉显示值1</option></select>
 </div>
 <div id="bg">
 </div>
