...
<head>
	...
	<script language="javascript" src="../original/Lodop6/DrugBillTemplet.js"></script>
        ...
        $(function () {
        	   ...
        	   var toolBarOption = { 
   	                   items: [
							 ...
							 $.pap.addTabItem({ 
		   	    	        	tabid: 'drugBillModify'+grid.selected[0]['id'],
			   	    	        text: '领药单/修改', 
			   	    	        url: 'drug_bill!loadUpdateById?id='+grid.selected[0]['id']
			   	    	     });
	   	   			      }},
	   	   	              { line:true },
	   	   	              ...
	   	   	              { text: '查看', icon: 'view', expression:'!=1', disabled:true, click: function(item){
		   	    				...
		   	    				$.pap.addTabItem({ 
			   	    				tabid: 'drugBillWare'+grid.selected[0]['id'],
		   	   	    				text: '领药单【'+grid.selected[0]['id']+'】',
		       	   					params:{ 'ids':ids,'id':grid.selected[0]['id']},
		   	   	    				url: 'drug_bill!loadDetailById?id='+grid.selected[0]['id']
		   	   	    			});
	   	   			      }},
	   	   				  { line:true },
	 	   			      ...
	 	   			      { text: '撤销', icon: 'back', expression:'!=1', disabled: true, click: function(item){
					            ...
					            if (selData['checkStatus'] != '1') {
				 	     	    ...
				 	     	    if (!(selData['drugTransfer'] ==null || selData['drugTransfer']=='')) {
					       			$.ligerDialog.warn('转接单生成，不允许撤销！');
									return;
				 	     	    }
	 	   			       ...
	 	   			       { line:true },
					            ...
					            if (flag1) {
				 	     	    ...
				 	     	    if (flag2) {
		   	    				...
		   	    				$.ligerDialog.confirm('确认要回执单据吗?', function(data) {
	 	   	          				if(data){
		 	   	          				$.ligerui.ligerAjax({
	   		      							type: "POST",
	   		      							async:  false,
	   		      							url: "drug_bill!receipt",
	   		      							data:{ ids: ids },
	   		      							dataType: "text",
	   		      							success: function(result, status){
	   		      								if(result != ""){
					            ...
					            if (selData['isReceipt'] == 'N') {
		   	   			     ...
		   	   			     { line:true },
  					         { text: '打印预览', icon: 'preview1',expression:'!=1', click: function(item){
        	 ...
        	 form = {
                 labelWidth: 70,
                 fields:[
						{ display: "领药单号", name:"e.id", type:"text" },
						...
						{ display: "领药时间", name: "e.tempStack.startTime", type: "date", space: 10 },
        	 ...
        	 var gridoption={
                    ...
                    url:'drug_bill!loadByPage',
                    exportBtn: true,
			        exportUrl: 'drug_bill!exportFile'
             }
