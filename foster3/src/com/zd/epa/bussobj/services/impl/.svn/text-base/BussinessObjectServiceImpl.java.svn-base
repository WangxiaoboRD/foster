package com.zd.epa.bussobj.services.impl;
...
import com.zd.epa.annotation.Bill;
import com.zd.epa.annotation.BussEle;
import com.zd.epa.annotation.MethodMeans;
import com.zd.epa.base.BaseServiceImpl;
import com.zd.epa.bussobj.dao.IBussinessObjectDao;
import com.zd.epa.bussobj.entity.BaseTable;
import com.zd.epa.bussobj.entity.BaseTableColumn;
import com.zd.epa.bussobj.entity.BussObjProperty;
...
import com.zd.epa.bussobj.entity.ImportantObj;
import com.zd.epa.bussobj.entity.MethodDesc;
import com.zd.epa.bussobj.entity.MethodDescDetail;
import com.zd.epa.bussobj.services.IBaseTableColumnService;
import com.zd.epa.bussobj.services.IBaseTableService;
import com.zd.epa.bussobj.services.IBussObjPropertyService;
import com.zd.epa.bussobj.services.IBussinessEleDetailService;
import com.zd.epa.bussobj.services.IBussinessEleService;
import com.zd.epa.bussobj.services.IBussinessObjectService;
import com.zd.epa.bussobj.services.IMethodDescDetailService;
import com.zd.epa.bussobj.services.IMethodDescService;
import com.zd.epa.bussobj.utils.ClassUtils;
import com.zd.epa.check.entity.CheckBill;
import com.zd.epa.check.services.ICheckBillService;
...
import com.zd.epa.permission.entity.AuthField;
import com.zd.epa.permission.entity.AuthObj;
import com.zd.epa.permission.entity.BussObjAuthProperty;
import com.zd.epa.permission.services.IAuthObjService;
import com.zd.epa.permission.services.IBussObjAuthPropertyService;
import com.zd.epa.permission.utils.PmUtil;
import com.zd.epa.utils.ISqlMap;
...
public class BussinessObjectServiceImpl extends BaseServiceImpl<BussinessObject, IBussinessObjectDao> implements IBussinessObjectService, ApplicationListener<ContextRefreshedEvent> {
	...
	public void refreshProperty() throws Exception {
		List<Class> classes = ClassUtils.getClasses("com.zd");
	...
	public void saveMethodDesc(Class<?> class1) throws Exception {
		...
		String classname = "com.zd.pb.services.impl." + class1.getSimpleName() + "ServiceImpl";
