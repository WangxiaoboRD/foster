...
//		System.out.println(daysBetween("2016-09-07", "2017-04-26"));
//		
//		System.out.println(dayNum("2017-04-28","2017-04-30"));
////
////		System.out.println(getEndDayOfWeekNo(2017,26));
//		System.out.println(PapUtil.getMonthLastDay("2017-04".substring(0, 4), "2017-04".substring(5)));
//
//	System.out.println(getDayNoTime(91,"2017-03-31"));
//		
//
//		System.out.println(getEndDayOfWeekNo(2017,26));
//		Assert.notNull("", "ids is not null");
//		String acc=null;
//		try{
//			Assert.hasText(acc, "a has text");
//		}catch(Exception e){
...
//		System.out.println(getEndDayOfWeekNo(2017,26));
		...
		System.out.println(compareDate("2017-10-01", "2017-10-07"));
		...
		System.out.println(getDayNoTime(21,"2017-09-01"));
