...
//@Result(type="json",name="json",params={"root","result"})
//public class BaseAction<E extends BaseEntity<ID>,Service extends IBaseService<E,ID>,ID extends Serializable> extends ActionSupport implements ParameterAware, SessionAware,ApplicationAware {
