 ...
 * 功能:
 * @author:wxb
 * @data:2017-7-26下午03:01:07
 * @file:DrugWarehouseDaoImpl.java
 */
...
import com.zd.epa.utils.HqlCallBack;
...
/**
 * 类名：  DrugWarehouseDaoImpl
 * 功能：
 * @author wxb
 * @date 2017-7-26下午03:01:07
 * @version 1.0
 * 
 */
public class DrugWarehouseDaoImpl extends BaseDaoImpl<DrugWarehouse> implements
		IDrugWarehouseDao {
	 ...
	 */
	public List<DrugWarehouse> selectHQLSingle(SqlMap<String, String, Object> sqlMap)throws Exception  {
		// TODO Auto-generated method stub
		// String hql = "from "+ clazz.getName()+" e where 1=1";
		String _hql = hqlModel.buildClassSelectHql(DrugWarehouse.class);
		String hql="";
		if (null != sqlMap) {
